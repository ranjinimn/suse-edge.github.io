...
* A SUSE Linux Micro {version-operatingsystem} raw image created using the <<guides-kiwi-builder-images, Kiwi Builder>>
...
The <<atip-management-cluster, SUSE Telco Cloud Management Cluster Documentation>> has examples of more advanced usage of Metal^3^ for telco use-cases.
